...
public class HairTest_Stage5_Male_Test extends BaseTest {
    ...
    @Test(description = "Verify Male User Can Fill All Details With Stage5", groups = {"regression"})
    @TestDescription("Verify the user can fill all the details with stage5 and proceed to payment")

    public void verifyMaleUserCanFillAllDetailsWithStage5() throws InterruptedException {
      ...
      //  Lead_You_Screen leadYouScreen = new Lead_You_Screen(DriverManager.getDriver());
        ...
        if(hairTestScreen.isHairLossTextDisplayed()==true) {
            ...
            Assert.assertTrue(hairTestScreen.isStage5TextOptionDisplayed(), "Stage 5 text option is not displayed");
            hairTestScreen.clickStage5Option();
