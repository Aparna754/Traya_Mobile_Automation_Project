...
public class HairTest_Stage4_Male_Test extends BaseTest {
    ...
    @Test(description = "Verify Male User Can Fill All Details With Stage4", groups = {"regression"})
    @TestDescription("Verify the user can fill all the details with stage4 and proceed to payment")

    public void verifyMaleUserCanFillAllDetailsWithStage4() throws InterruptedException {
      ...
      //  Lead_You_Screen leadYouScreen = new Lead_You_Screen(DriverManager.getDriver());
        ...
        if(hairTestScreen.isHairLossTextDisplayed()==true) {
            ...
            Assert.assertTrue(hairTestScreen.isStage4TextOptionDisplayed(), "Stage 4 text option is not displayed");
            hairTestScreen.clickStage4Option();
